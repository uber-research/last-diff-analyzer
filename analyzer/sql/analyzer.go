...
// Package sql implements the main logic of the analysis for sql
// files. It currently supports auto-approval of changes to sql
// files which involve comments and formatting.
package sql

// Analyzer is an analyzer for SQL files.
